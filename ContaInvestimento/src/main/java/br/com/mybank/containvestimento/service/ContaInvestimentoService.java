package br.com.mybank.containvestimento.service;
import br.com.mybank.containvestimento.domain.ContaInvestimento;
import br.com.mybank.containvestimento.domain.Operacoes;
import br.com.mybank.containvestimento.domain.TransacoesEmCI;
import br.com.mybank.containvestimento.repository.ContaInvestimentoRepository;
import br.com.mybank.containvestimento.response.TransacoesEmCC;
import com.auth0.jwt.JWT;
import com.auth0.jwt.exceptions.JWTDecodeException;
import br.com.mybank.containvestimento.repository.TransacoesEmCIRepository;
...
public class ContaInvestimentoService {
    ...
    public ResponseEntity<?> adicionarContaInvestimento(ContaInvestimento contaInvestimento, String token) throws JSONException, IOException, JSONException {
    ...
    public ResponseEntity<?> atualizarInvestimento(ContaInvestimento contaInvestimento, String token) throws JSONException, IOException {
    ...
    public ResponseEntity<?> removerContaInvestimento(String token) throws JSONException, IOException {
        ...
        ContaInvestimento contaInvestimento = listarPorIdUsuario((Integer) tokenJson.get("id")).get();
    ...
    public ResponseEntity<?> retirada(TransacoesEmCI retirada, String token) throws JSONException, IOException {
        JSONObject tokenJson = new JSONObject(jwtFilter(token));
        ...
        Optional<ContaInvestimento> contaInvestimentoOptional = listarPorIdUsuario((Integer) tokenJson.get("id"));
        BigDecimal saldoCI = contaInvestimentoOptional.get().getSaldoContaInvestimento();
